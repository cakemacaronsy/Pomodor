// Usage: powers the separate red Pomodoro dashboard in red.html; no build step or dependencies are required.
const modes = {
...
const themeStorageKey = "sean-red-pomodoro-theme-v1";
...
function applyTheme(theme) {
  ...
  elements.themeLabel.textContent = isDark ? "淺色模式" : "深色模式";
}
